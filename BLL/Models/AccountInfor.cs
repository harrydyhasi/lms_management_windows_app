...
namespace BLL.Models
{
    public class AccountInfor
    {
        ...
        public AccountInfor(string username, string avatarPath, string fName, string mName, string lName, string email, string phoneNumb, DateTime dateOfBirth, string address)
        {
            Username = username;
        ...
        public AccountInfor(DataRow row)
        {
