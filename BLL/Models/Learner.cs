...
namespace BLL.Models
{
    public class Learner
    {
        ...
        public Learner(string username, string avatarPath, string fName, string mName, string lName, string email, string phoneNumb, DateTime dateOfBirth, string address)
        {
            Username = username;
