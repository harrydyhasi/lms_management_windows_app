...
namespace BLL.Models
{
    public  class Lecturer
    {
        ...
        public Lecturer(string username, string avatarPath, string fName, string mName, string lName, string email, string phoneNumb, DateTime dateOfBirth, string address)
        {
            Username = username;
